...
## Project Structure
    ...
    ├── testapiautoteammemb_73062  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_73062`
...
2. Clone this repo and `cd testapiautoteammemb_73062`
